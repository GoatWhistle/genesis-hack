...
module Rsocket
  module Generate
    ...
    ServiceContext = Data.define(
      ...
      :duplicate_status, :minor_units, :minimum_amount,
      ...
      def defaults
        {
          ...
          minimum_amount: nil,
          status_map: {}, error_map: {}, event_map: {}, signature: nil, webhook_id_field: nil,
          webhook_event_field: nil, response_id_path: ["id"], response_status_path: ["status"],
          error_code_path: %w[error code], requisite_builders: [], required_requisite_fields: [],
          payout_method_field: nil, payout_methods: [],
          skipped_optional: [], manual_required: [], notes: []
        }
      end
    end
