...
module Adapter
  module Loader
    # Разбор текста описания API. Форматы одни и те же независимо от того, откуда
    # текст взялся — с диска или из тела HTTP-запроса, — поэтому разбор общий, а
    # источник у каждого адаптера свой.
    module Document
