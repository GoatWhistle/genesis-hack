...
module Rsocket
  ...
  FILES = [
    ...
    "config/rule", "config/signal", "config/settings", "config/catalog", "config/vocabulary",
    "config/importer", "config/storage",
    "service/adapter_builder/parsing/data_path",
    ...
    "service/adapter_builder/analysis/resource_parameters",
    "service/adapter_builder/analysis/call_planner",
    "service/adapter_builder/analysis/fixture_planner",
    "service/adapter_builder/analysis/response_fields",
